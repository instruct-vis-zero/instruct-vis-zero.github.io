            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["pan", "similar", 2]],
                        action: "Allowing the egg to cook until the edges are crispy and the yolk is set to desired firmness.",
                        state_of_main_object:
                            " The heated pan on the stove contains a fully cooked egg with crispy edges and a yolk set to the desired firmness.",
                    },
                    {
                ...
                steps: [
                    {
                        ...
                        object: [["microwave bag of popcorn", "new"]],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["microwave bag of popcorn", "similar", 1],
                            ["bowl", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["parfait glass", "similar", 1]],
                    ...
                    {
                        step: "Adding Fruits",
                        object: [["parfait glass", "similar", 2]],
                    ...
                    {
                        step: "Garnishing",
                        object: [["parfait glass", "similar", 3]],
                        action: "Garnishing the top with a drizzle of honey or a sprinkle of seeds.",
                        state_of_main_object:
                            " The tall glass now contains a parfait with layers of yogurt, granola, fruit, and is garnished with honey or seeds.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.8, 0.7],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The pot now holds boiling water with cooked instant noodles and the added flavor from the packet, stirred in to mix evenly.",
                    },
                    {
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["bread slices", "similar", 2]],
                        action: "Covering the fillings with the second slice of bread.",
                        state_of_main_object:
                            " A sandwich is assembled on the cutting board, consisting of the two slices of bread, with layers of meats, cheese, and vegetables in between.",
                    },
                    {
                        step: "Serving the Sandwich",
                        object: [
                            ["bread slices", "similar", 3],
                            ["plate", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The pot now contains a smooth, homogeneous mixture of hot chocolate, perfectly melted and mixed in simmering milk.",
                    },
                    {
                        step: "Serving",
                        object: [["mug", "new"]],
                        ...
                        state_of_main_object:
                            " A mug filled with smooth, hot chocolate, possibly topped with marshmallows or whipped cream, is now ready to enjoy.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.9, 0.1],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The tall glass is filled with a gin and tonic mix, ice cubes, and garnished with a slice of lime. The drink is evenly stirred.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.9, 0.9],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " Several scoops of ice cream, now garnished with toppings like sprinkles or chocolate syrup, sit ready to be served.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.5],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Serving",
                        object: [
                            ["vegetables", "similar", 2],
                            ["plate", "new"],
                        ],
                        action: "Arranging the sliced vegetables on a serving plate or dish.",
                        state_of_main_object:
                            " A serving plate or dish is now filled with sliced vegetables such as carrots, cucumbers, and bell peppers organized neatly.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.5],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["teapot", "similar", 3]],
                        action: "Letting the tea steep for a few minutes, then pouring it from teapot into cups.",
                        state_of_main_object:
                            " Cups of freshly steeped herbal tea have been poured from the teapot, which is now empty or contains less tea.\n",
                    },
                ],
                relation: [
                    [1.0, 0.0, 0.9, 0.5],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["light fixture", "similar", 1]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["completed desk", "similar", 3]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The margarita glass, previously rimmed with salt, now contains the shaken mixture of tequila, lime juice, and triple sec.",
                    },
                ],
                relation: [
                    [1.0, 0.1, 0.1, 0.9],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["bookshelf pieces", "similar", 1],
                            ["screwdriver", "new"],
                        ],
                        action: "Using a screwdriver to attach the sides to the base of the bookshelf.",
                        state_of_main_object:
                            " The base of the bookshelf is now attached to the sides with screws, forming the initial structure on the floor.",
                    },
                    {
                        step: "Adding the Shelves",
                        object: [["bookshelf pieces", "similar", 1]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The bowl now holds a mixture of ripe avocado flesh, chopped onions, tomatoes, cilantro, with lime juice, and salt added.\n",
                    },
                    {
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["Christmas tree", "similar", 1]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The birthday cake is frosted, decorated with edible items, and has a birthday message written on it with icing.",
                    },
                    {
                        step: "Adding Candles",
                        object: [
                        ...
                        state_of_main_object:
                            " The birthday cake is fully decorated with frosting, edible decorations, a written message, and birthday candles.",
                    },
                ],
                relation: [
                    [1.0, 0.8, 0.7, 0.6],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " A completed desk setup contains a computer monitor, keyboard, mouse, and office supplies along with decorative items like plants and framed pictures.",
                    },
                ],
                relation: [
                    [1.0, 0.6, 0.7, 0.5],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The wall now displays a gallery of various framed pictures and artworks, placed according to a well-measured layout.",
                    },
                    {
                        step: "Final Adjustments",
                        object: [["wall", "similar", 2]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The patio is decorated with suitable outdoor furniture, defined seating areas marked with outdoor rugs, enhanced evening ambiance through string lights or lanterns, and it is embellished with potted plants for greenery.",
                    },
                ],
                relation: [
                    [1.0, 0.6, 0.5, 0.5],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The festive tablecloth-covered dining table now has plates and cutlery arranged in precise positions for each seat.",
                    },
                    {
                        ...
                        state_of_main_object:
                            " The tablecloth-covered dining table is set with plates and cutlery for each seat, and a festive centerpiece adorns the middle of the table.",
                    },
                    {
                        ...
                        state_of_main_object:
                            " A festive table is set up with neatly arranged plates, cutlery, a centerpiece, and decorative napkins alongside small festive items.",
                    },
                ],
                relation: [
                    [1.0, 0.7, 0.6, 0.6],
        ...
        goals: [
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The drip tubing, arranged around plants in the garden, is now connected through various sections via connectors.",
                    },
                    {
                        ...
                        state_of_main_object:
                            " The drip tubing, now connected in sections, is attached to a water faucet creating a completed irrigation system setup.",
                    },
                    {
                        step: "Testing the System",
                        object: [["tubing", "similar", 1]],
                        action: "Turning on the faucet and checking for proper water flow through the tubing.",
                        state_of_main_object:
                            " The drip irrigation system is now set up and operational with water flowing properly through the connected tubing.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.9, 0.9],
            ...
            },
            {
                ...
                steps: [
                    ...
                    {
                        step: "Final Setup",
                        object: [["patio space", "similar", 1]],
                        action: "Adding finishing touches such as outdoor cushions and a small fire pit.",
                        state_of_main_object:
                            " The patio is fully set up with arranged furniture, decorations, and added final touches of outdoor cushions and a fire pit.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.9, 0.9],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The pathway is complete, with securely placed stones embedded in gravel, and the gaps between them filled with sand.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.9, 0.9],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " In the tall parfait glass, there are layers of yogurt, fresh mixed berries, and a sprinkling of granola on top.",
                    },
                    {
                        step: "Garnishing and Serving",
                        object: [
                            ["parfait glass", "similar", 3],
                            ["mint leaves", "new"],
                        ],
                        action: "Garnishing the top with mint leaves and perhaps a few more berries before serving.",
                        state_of_main_object:
                            " A gourmet Berry Parfait is standing ready, characterized by layers of yogurt, mixed berries, and granola, topped with mint leaves and additional berries as garnish.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.9, 0.9],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The interior of the closet is empty and clean, while groups of items to keep, donate, and discard are carefully separated outside.",
                    },
                    {
                        step: "Reorganizing the Closet",
                        object: [
                            ["closet", "similar", 1],
                            ["organized clothing", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["furniture", "similar", 3],
                            ["living room", "similar", 1],
                        ],
                        action: "Putting furniture and any moved items back into their original positions.",
                        state_of_main_object:
                            " The living room is tidy, with all furniture and items returned to their places and the carpet thoroughly vacuumed.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.0, 0.0],
                ...
                steps: [
                    {
                        ...
                        state_of_main_object:
                            " A hand has been introduced into the pot, with its fingers touching the pot's soil to assess the plant's watering needs.",
                    },
                    {
                        ...
                        state_of_main_object:
                            " The fingers touch the soil in the pot for moisture checking while the watering can is ready and filled with water.",
                    },
                    {
                        step: "Watering the Plant",
                        object: [
                            ["plant", "similar", 1],
                            ["watering can", "similar", 2],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["flowering plant", "similar", 2],
                            ["pruning shears", "similar", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["basket of tomatoes", "similar", 3]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Picking Apples",
                        object: [
                            ["ripe apples", "similar", 1],
                            ["ladder", "new"],
                        ],
                        action: "Using a ladder to reach high branches and carefully twisting apples off the tree.",
                        state_of_main_object:
                            " The apple tree has fewer apples, and some ripe apples now lay nearby, carefully plucked from the higher branches.",
                    },
                    {
                        step: "Gathering Apples",
                        object: [
                            ["picked apples", "similar", 2],
                            ["basket", "new"],
                        ],
                    ...
                    {
                        step: "Storing Apples",
                        object: [["basket of apples", "similar", 3]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["harvested strawberries", "similar", 2],
                            ["basket", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [["basket of strawberries", "similar", 3]],
                        action: "Storing the basket in a cool place or refrigerating to maintain freshness.",
                        state_of_main_object:
                            " A basket filled with freshly picked strawberries is now stored in a cool place or a refrigerator to remain fresh.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.0, 0.0],
            ...
            },
            {
                ...
                steps: [
                    ...
                    {
                        step: "Storing Herbs",
                        object: [["basket of herbs", "similar", 3]],
                        action: "Storing the herbs in a cool, dry place or using them fresh to ensure flavor is preserved.",
                        state_of_main_object:
                            " The mature herbs are harvested and placed either in storage in a cool, dry place or used immediately, thereby preserving their flavor.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.0, 0.0],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["chopped lettuce", "similar", 2],
                            ["sliced tomatoes", "similar", 2],
                            ["bowl", "new"],
                        ],
        ...
        goals: [
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["cake", "similar shape", 3],
                            ["plastic characters", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["raspberry mixture", "similar shape", 1],
                            ["saucepan", "similar", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["raspberry mixture", "similar shape", 2],
                    ...
                    },
                    {
                        ...
                        object: [["raspberry puree", "similar texture", 3]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["glass dish", "similar shape", 1]],
                    ...
                    },
                    {
                        ...
                        object: [["glass dish", "similar shape", 2]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["mixture", "similar shape", 2]],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["mixture", "similar texture", 3],
                            ["saucepan", "similar", 1],
                            ["wooden chopping board", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["tomato plant", "similar", 2],
                            ["suckers", "new"],
                        ],
                        action: "A person using their fingers to gently remove small suckers that appear between the branches of the tomato plant.",
                        state_of_main_object:
                            " The tomato plant is well-hydrated and fertilized, with all the small suckers removed from between its branches.",
                    },
                    {
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["pot", "similar", 2],
                            ["onion pieces", "similar", 3],
                            ["carrot slices", "similar", 2],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["bowl", "new"],
                            ["grilled wings", "similar", 1],
                            ["soup base powder", "new"],
                            ["milk", "new"],
                            ["water", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["sweet potato mixture", "similar", 1],
                            ["sugar", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["sweet potato mixture", "similar", 2],
                            ["pecan mixture", "similar", 3],
                            ["baking dish", "new"],
                        ],
                        ...
                        state_of_main_object:
                            " A baking dish contains a layer of mashed sweet potato topped with a mixture of brown sugar and chopped pecans. It's then baked until golden and slightly bubbly.",
                    },
                ],
                relation: [
                    [1.0, 0.9, 0.7, 0.6],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The ready-to-eat creamy potato soup, hot and garnished with green onions or chives, is served in bowls on the table.",
                    },
                ],
                relation: [
                    [1.0, 0.5, 0.3, 0.2],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["cutting board", "new"],
                            ["grilled beef", "similar", 1],
                        ],
                        action: "Slice the rested beef thinly against the grain on a cutting board.",
                        state_of_main_object:
                            " Thinly sliced, rested beef is laying on a cutting board, with a mixture of sliced vegetables and herbs in a large bowl next to it.",
                    },
                    {
                        step: "Combining Beef and Salad",
                        object: [
                            ["bowl", "similar", 2],
                            ["sliced beef", "similar", 3],
                        ],
                        action: "Add the sliced beef to the salad and toss with Thai dressing.",
                        state_of_main_object:
                            " The large bowl now contains a Thai beef salad - grilled beef slices mixed with cucumbers and tomatoes, fresh herbs, and dressed with Thai dressing.\n",
                    },
                ],
                relation: [
                    [1.0, 0.7, 0.7, 0.6],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["baking dish", "new"],
                            ["meat mixture", "similar", 2],
                            ["mashed potatoes", "new"],
                        ],
                        action: "Layer the meat mixture in a baking dish, then top with mashed potatoes.",
                        state_of_main_object:
                            " A baking dish is filled with a bottom layer of cooked meat and vegetables, topped by a layer of mashed potatoes.",
                    },
                    {
                        step: "Baking the Pie",
                        object: [
                            ["oven", "new"],
                            ["shepherd's pie", "similar", 3],
                        ],
                        action: "Bake in a preheated oven until the top is golden and crispy.",
                        state_of_main_object:
                            " A freshly baked Shepherd's Pie exuding a tantalizing aroma, with a golden crispy mashed potato topping sits in the oven.",
                    },
                ],
                relation: [
                    [1.0, 0.8, 0.6, 0.4],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["bowl with tomato juice", "similar", 2],
                            ["honey", "new"],
                            ["yogurt", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [["facial mask mixture", "similar", 3]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    {
                        step: "Applying the Mask",
                        object: [["yogurt mixture", "similar", 2]],
        ...
        goals: [
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Baking",
                        object: [
                            ["avocado", "total similar", 2],
                            ["oven", "total similar", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["beans", "shape similar", 1],
                            ["water", "total similar", 1],
                            ["bowl", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["beans", "shape similar", 2],
                            ["water", "shape similar", 2],
                            ["pot", "new"],
                            ["stove", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["beans", "shape similar", 3],
                            ["water", "shape similar", 3],
                            ["pot", "total similar", 3],
                            ["stove", "total similar", 3],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["broccoli", "similar(total similar)", 1],
                            ["knife", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["peppers", "similar (total similar)", 1],
                            ["knife", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["peppers", "similar (total similar)", 2],
                            ["pan", "similar (total similar)", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["honeydew melon", "similar shape", 1],
                            ["knife", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["melon half", "similar shape", 3],
                            ["knife", "similar total", 2],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["dragon fruit", "similar(total similar)"],
                            ["knife", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["dragon fruit", "similar(texture similar)"],
                            ["spoon", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["dragon fruit", "similar(shape similar)"],
                            ["knife", "same as step 2"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Drying Apples",
                        object: [
                            ["apple", "similar(total similar)", 2],
                            ["oven", "similar(total similar)", 1],
                            ["tray", "similar(total similar)", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["potato", "similar(total similar)", 1],
                            ["knife", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["potato pieces", "similar(texture similar)", 2],
                            ["juicer", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["potato pieces", "similar(shape similar)", 3],
                            ["juicer", "similar(total similar)", 3],
                        ],
                ...
                steps: [
                    {
                        ...
                        object: [["ingredients (apples, sugar, spices)", "new"]],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["bowl", "new"],
                            ["ingredients (apples)", "similar shape", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["apple puree", "similar shape", 1],
                            ["ingredients (spices, sugar)", "similar total", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["banana", "similar shape", 2],
                            ["milk", "similar total", 1],
                            ["sugar", "similar total", 1],
                            ["blender", "similar total", 1],
                        ],
                        action: "Add the banana chunks, milk and sugar to the blender. Close the lid and blend all the ingredients.",
                        state_of_main_object:
                            " All the ingredients - banana chunks, milk, and sugar - have been blended together in the blender to create a smooth mixture.",
                    },
                    {
                        step: "Pouring into a glass",
                        object: [
                            ["blender", "similar total", 3],
                            ["glass", "new"],
                            ["straw", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["carrots", "similar texture", 2],
                            ["water", "similar texture", 1],
                            ["blender", "new"],
                            ["sugar", "similar shape", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["carrot blend", "similar(texture)", 3],
                            ["strainer", "new"],
                            ["glass", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["coconut halves", "similar shape", 1],
                            ["coconut scraper", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["coconut meat", "similar texture", 2],
                            ["water", "new"],
                            ["blender", "new"],
                        ],
                    ...
                    },
                    {
                        step: "Straining the Mixture",
                        object: [
                            ["coconut mixture", "similar shape", 3],
                            ["strainer", "new"],
                            ["bowl", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Let it Steep",
                        object: [
                            ["water", "similar(total similar)", 2],
                            ["cinnamon", "similar shape", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Pour Hot Water",
                        object: [
                            ["cup", "similar shape", 0.8],
                            ["kettle", "similar shape", 0.8],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["ice tray", "similar shape", 1]],
                        action: "Wait for a few hours for the water to freeze into ice cubes.",
                        state_of_main_object:
                            " The ice tray, previously filled with water, is now set in the refrigerator with the water transformed into frozen ice cubes.",
                    },
                ],
                relation: [
                    [1.0, 0.5, 0.4, 0.3],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["milk", "shape similar", 1],
                            ["chocolate", "similar (total)", 2],
                            ["ice cubes", "similar shape", 1],
                            ["dairy cream", "similar shape", 1],
                            ["blender", "similar (total)", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Fermentation",
                        object: [
                            ["rice-kji mixture", "similar(texture similar)", 3],
                            ["water", "similar(total similar)", 2],
                            ["yeast", "new"],
                        ],
                        action: "Put the rice-koji mixture in a tub, add water and yeast to start the fermentation process.",
                        state_of_main_object:
                            " A tub is filled with a fermenting mixture of rice, koji, water, and yeast, initiating the process of sake production.",
                    },
                ],
                relation: [
                    [1.0, 0.5, 0.3, 0.2],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["rubber", "new"],
                            ["cloth", "similar(shape similar)", 2],
                            ["soapy water", "similar(total similar)", 2],
                        ],
                    ...
                    {
                        step: "Dry the Rubber",
                        object: [["rubber", "similar(total similar)", 3]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["broom", "similar(total similar)", 1],
                            ["dustpan", "similar(total similar)", 1],
                            ["pet hair", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["broom", "similar(total similar)", 2],
                            ["dustpan", "similar(total similar)", 2],
                            ["pet hair", "similar(total similar)", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["dustpan", "similar(total similar)", 3],
                            ["trash bag", "new"],
                            ["pet hair", "similar(total similar)", 2],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    {
                        step: "Rinse and Dry",
                        object: [["curtains", "texture similar", 1]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["carpet", "similar shape", 1],
                            ["detergent solution", "new"],
                            ["cloth", "new"],
                        ],
                        action: "Add some detergent solution onto a cloth and dab it on the stained area.",
                        state_of_main_object:
                            " The stained area of the carpet is slightly damp, with detergent solution applied, and the loose chocolate pieces have been removed.",
                    },
                    {
                        step: "Blotting the Stain",
                        object: [
                            ["carpet", "similar shape", 1],
                            ["cloth", "similar shape", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["canvas", "new"],
                            ["soapy water", "similar(texture similar)", 3],
                            ["cloth", "similar(total similar)", 4],
                        ],
                        action: "Dip the soft cloth in the soapy water and gently clean the canvas.",
                        state_of_main_object:
                            " The canvas is now being gently cleaned with a soft cloth dipped in soapy water, therefore it's moist and undergoing cleaning.",
                    },
                    {
                        step: "Dry the Canvas",
                        object: [
                            ["canvas", "similar(total similar)", 5],
                            ["dry cloth", "similar(texture similar)", 6],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Soaking",
                        object: [
                            ["dirty baseball", "shape similar", 1],
                            ["soapy water", "similar", 1],
                        ],
                    ...
                    },
                    {
                        step: "Scrubbing",
                        object: [
                            ["soaking baseball", "similar shape", 1],
                            ["soft cloth", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["mushroom", "similar total", 2],
                            ["cutting board", "similar total", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["mushroom", "similar shape", 3],
                            ["knife", "similar total", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["cutting board", "similar shape", 2],
                            ["sushi roll", "similar shape", 2],
                            ["knife", "similar texture", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The laptop is clean and ready for decoration. The individual has a selection of desired laptop-compatible stickers at hand.",
                    },
                    {
                        step: "Apply Stickers",
                        object: [
                            ["laptop", "similar texture", 1],
                            ["stickers", "similar(total similar)", 2],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [["laptop", "similar texture", 3]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["adhesive tape", "similar texture"],
                            ["elastic string", "new"],
                        ],
                        action: "Attach an elastic string at the base of the cone hat using adhesive tape.",
                        state_of_main_object:
                            " A cone hat, secured with adhesive tape and having an elastic string attached at its base, is complete and ready to wear.",
                    },
                ],
                relation: [
                    [1.0, 0.7, 0.4, 0.2],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["drone frame", "similar shape", 1],
                            ["electronics (flight controller, ESCs, etc.)", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    {
                        step: "Cooling Down",
                        object: [["frisbee", "similar(shape)", 3]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["fabric", "similar total", 1],
                            ["paints", "similar total", 1],
                            ["brushes", "similar total", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [["rod with attached flag", "shape transform", 1]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["cardstock", "texture similar", 1]],
                    ...
                    },
                    {
                        ...
                        object: [["cardstock", "shape similar", 2]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Mixing Ingredients",
                        object: [
                            ["green tea", "similar(total similar)", 1],
                            ["honey", "similar(total similar)", 1],
                            ["lemon", "similar(total similar)", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["face", "new"],
                            ["Green Tea Mixture", "similar texture", 2],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["paper", "similar total", 3]],
                        action: "Flip the hat over and repeat the last step.",
                        state_of_main_object:
                            " The Pirate Hat is completely made from black paper, double-folded at the base on both sides to keep the triangular shape secure.",
                    },
                ],
                relation: [
                    [1.0, 0.8, 0.6, 0.4],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["fruit", "similar(total similar)", 1],
                            ["melted chocolate", "similar(total similar)", 2],
                        ],
                    ...
                    {
                        step: "Cooling Down",
                        object: [["fruit", "similar(shape similar)", 3]],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["bread", "similar shape", 1],
                            ["oven", "similar total", 1],
                            ["oven tray", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["sandals", "similar(total similar)", 1],
                            ["brush", "similar(total similar)", 1],
                            ["soapy water", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["sandals", "similar(total similar)", 2],
                            ["towel", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Dust Removal",
                        object: [
                            ["silk flowers", "similar texture", 1],
                            ["soft brush", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["soybeans", "similar (total similar)", 1],
                            ["water", "similar (total similar)", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["soybeans", "similar (total similar)", 2],
                            ["colander", "new"],
                            ["water", "similar (total similar)", 2],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["soybeans", "similar (shape similar)", 3],
                            ["pot", "new"],
                            ["water", "similar (total similar)", 3],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["Zucchini", "similar (total similar)", 1],
                            ["knife", "new"],
                        ],
                    ...
                    },
                    {
                        step: "Making Zoodles",
                        object: [
                            ["Zucchini", "similar (total similar)", 2],
                            ["spiralizer", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["Zoodles", "similar (shape similar)", 3],
                            ["pan", "new"],
                            ["oil", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        state_of_main_object:
                            " The baby rabbit, held upright, is beginning to accept the nipple of the bottle containing warm rabbit milk replacer.",
                    },
                    {
                        step: "Returning Rabbit to Cage",
                        object: [
                            ["baby rabbit", "similar shape", 1],
                            ["cage", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["pruners", "similar total", 1],
                            ["lavender plant", "similar total", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["scissors", "similar texture", 1],
                            ["basket", "similar shape", 1],
                            ["red clover", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["scissors", "total similar", 2],
                            ["basket", "similar shape", 2],
                            ["red clover", "similar shape", 2],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["basket", "similar shape", 3],
                            ["red clover", "similar shape", 3],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["rock fish", "similar(total similar)", 1],
                            ["garlic", "similar(total similar)", 1],
                            ["olive oil", "similar(total similar)", 1],
                            ["lemon", "similar(total similar)", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["rock fish", "similar(total similar)", 2],
                            ["oven", "similar(total similar)", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["cup", "similar shape", 1],
                            ["container", "similar(total similar)", 2],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Cutting Fabric",
                        object: [
                            ["fabric", "similar(total similar)", 1],
                            ["scissors", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["halved potato", "similar shape", 1],
                            ["knife", "similar whole", 0],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["card stock", "total similar", 1]],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["card", "similar shape", 1],
                            ["marker", "similar total", 1],
                            ["stickers", "similar total", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["card", "similar shape", 1],
                            ["stickers", "simliar shape", 1],
                            ["glue", "similar total", 1],
                        ],
                        action: "Person uses glue to fix the stickers on the front of the card.",
                        state_of_main_object:
                            " The birthday card is finished, with stickers firmly attached to the front and a birthday message written inside.",
                    },
                ],
                relation: [
                    [1.0, 0.6, 0.4, 0.2],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["vase with flowers", "similar shape", 1],
                            ["greenery", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["vase with flowers and greenery", "similar total", 1],
                            ["wrap", "new"],
                        ],
                        action: "Wrap the bouquet with decorative wrap.",
                        state_of_main_object:
                            " A beautiful, well-arranged bouquet of different flowers, accented with greenery and smaller flowers, wrapped in a decorative wrap is ready.",
                    },
                ],
                relation: [
                    [1.0, 0.5, 0.4, 0.3],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["plastic wrap", "similar(total similar)", 1],
                            ["candy", "similar(total similar)", 1],
                            ["scissors", "similar(total similar)", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["plastic wrap", "similar(total similar)", 2],
                            ["candy", "similar(total similar)", 2],
                            ["ribbon", "similar(total similar)", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["plastic wrap", "similar(total similar)", 3],
                            ["ribbon", "similar(total similar)", 2],
                            ["scissors", "similar(total similar)", 2],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["base materials", "new"],
                            ["location", "similar(total similar)", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["lumber", "total similar", 1],
                            ["nails", "total similar", 1],
                            ["hammer", "total similar", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["lumber", "total similar", 2],
                            ["nails", "total similar", 2],
                            ["hammer", "total similar", 2],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["lumber", "total similar", 3],
                            ["nails", "total similar", 3],
                            ["hammer", "total similar", 3],
                        ],
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ...
                            ["lettuce", "new"],
                            ["tomato", "new"],
                            ["chicken", "similar shape", 2],
                        ],
                        action: "Place the lettuce, tomato and cooked chicken between the two halves of the bun.",
                        state_of_main_object:
                            " A chicken burger has been assembled with lettuce, tomato, and cooked chicken layered between the two halves of a bun.",
                    },
                    {
                        step: "Serving",
                        object: [
                            ["burger", "similar total", 3],
                            ["plate", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [["cut paper", "similar texture", 2]],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["star shaped paper", "similar shape", 3],
                            ["glitter", "new"],
                        ],
                ...
                steps: [
                    {
                        ...
                        object: [
                            ["wax", "new"],
                            ["candle wick", "new"],
                            ["cinnamon essential oil", "new"],
                            ["candle container", "new"],
                        ],
                        action: "Begins with gathering the candle wax, candle wick, cinnamon essential oil, and a candle container.",
                        state_of_main_object:
                            " Wax, wick, cinnamon essential oil, and a candle container are assembled together, ready for the candle making process.",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        object: [
                            ["wax", "similar texture", 1],
                            ["cinnamon essential oil", "similar total", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["candle container", "similar total", 1],
                            ["wax", "similar texture", 2],
                            ["candle wick", "similar total", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["clay lump", "new"],
                            ["dragon body", "similar texture", 3],
                        ],
                        action: "Form another piece of clay into a whip-like tail and two wings, then attach them to the body.",
                        state_of_main_object:
                            " A fully-formed clay dragon stands, featuring a body with a head, four legs, a whip-like tail, and two wings attached.",
                    },
                ],
                relation: [
                    [1.0, 0.7, 0.5, 0.3],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Adding Wings",
                        object: [
                            ["clay", "similar texture", 1],
                            ["body", "similar shape", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["clay", "similar texture", 1],
                            ["body", "shape similar", 2],
                        ],
                        action: "Shape a small triangle and attach to one end of the bird as the beak.",
                        state_of_main_object:
                            " An oval clay shape with two small ovals on its sides forms the bird's body and wings. After attaching a small triangular piece as the beak, the bird sculpture takes more realistic shape.",
                    },
                ],
                relation: [
                    [1.0, 0.6, 0.4, 0.2],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Mixing Ingredients",
                        object: [
                            ["juicer", "similar shape", 1],
                            ["water", "shape similar", 1],
                            ["honey", "shape similar", 1],
                            ["bowl", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["water-filled hole", "similar texture", 2],
                            ["lotus plant", "new"],
                        ],
                ...
                steps: [
                    {
                        ...
                        state_of_main_object:
                            " The workstation is equipped with a sheet of steel, a hammer, and a welder, ready for the next steps in creating a steel rose.",
                    },
                    {
                        step: "Cutting Petal Shapes",
                        object: [
                            ["steel sheet", "similar shape", 1],
                            ["scissors", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["steel petal", "similar shape", 2],
                            ["hammer", "texture similar", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["steel petals", "similar shape", 3],
                            ["welder", "total similar", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Cooking Meat",
                        object: [
                            ["Ground meat", "similar(total similar)", 1],
                            ["Pan", "new"],
                            ["Stove", "new"],
                        ],
                    ...
                    },
                    {
                        step: "Adding Vegetables",
                        object: [
                            ["Cooked meat", "similar(texture similar)", 2],
                            ["Peas", "similar(total similar)", 1],
                            ["Carrots", "similar(total similar)", 1],
                            ["Pumpkin", "similar(total similar)", 1],
                        ],
                    ...
                    },
                    {
                        step: "Serving Food",
                        object: [
                            ["Kitten food", "similar(texture similar)", 3],
                            ["Kitten dish", "new"],
                        ],
                ...
                steps: [
                    {
                        ...
                        state_of_main_object:
                            " A collection of dense hardwood chips, a charcoal grill, and a lidded metal canister are prepared and ready for use.",
                    },
                    {
                        step: "Preparing The Grill",
                        object: [
                            ["charcoal grill", "same"],
                            ["wood chips", "similar (on grill)", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["metal canister", "same"],
                            ["charcoal grill", "similar (canister on top)", 2],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["smoke", "new"],
                            ["metal canister", "similar (smoke inside)", 3],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Cut the Pieces",
                        object: [
                            ["cardboard", "shape similar", 1],
                            ["scissors", "similar total", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["cardboard pieces", "similar total", 2],
                            ["glue", "similar total", 1],
                        ],
                ...
                steps: [
                    {
                        ...
                        state_of_main_object:
                            " All necessary materials including a glass jar, a small figurine, glitter, glycerin, and distilled water are gathered together.",
                    },
                    {
                        step: "Preparing the Figurine",
                        object: [
                            ["figurine", "similar(total similar)", 1],
                            ["glass jar lid", "similar(shape similar)", 2],
                            ["waterproof glue", "new"],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["glass jar", "similar(total similar)", 1],
                            ["glitter", "similar(texture similar)", 3],
                            ["glycerin", "similar(total similar)", 4],
                            ["distilled water", "similar(total similar)", 5],
                        ],
                        action: "Fill the jar almost to the top with distilled water, add a pinch of glitter and a dash of glycerin.",
                        state_of_main_object:
                            " The glass jar is nearly filled with distilled water, containing a sprinkle of glitter and a slight addition of glycerin.",
                    },
                    {
                        step: "Assemble the Snow Globe",
                        object: [
                            ["glass jar", "similar(total similar)", 1],
                            ["glass jar lid", "similar(total similar)", 2],
                            ["figurine", "similar(total similar)", 3],
                        ],
                        action: "Screw the lid tightly onto the jar. Turn the jar upside down.",
                        state_of_main_object:
                            " An inverted snow globe with a figurine glued to the inside of the lid, glitter floating in the water-glycerin mix in the glass jar.",
                    },
                ],
                relation: [
                    [1.0, 0.2, 0.1, 0.05],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["tulle", "similar shape", 2],
                            ["comb", "total similar", 1],
                            ["needle", "total similar", 2],
                            ["thread", "total similar", 2],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [["veil", "similar texture", 3]],
                        action: "Hold the veil by the comb and place it onto the head to finalize.",
                        state_of_main_object:
                            " The wedding veil, attached to a comb, is now placed on the head, completing the process of making a wedding veil.",
                    },
                ],
                relation: [
                    [1.0, 0.2, 0.1, 0.0],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["rice", "similar (total similar)", 3],
                            ["milk", "similar (total similar)", 1],
                            ["fire", "similar (total similar)", 1],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["water", "similar (total similar)", 2],
                            ["starch", "similar (total similar)", 1],
                        ],
                    ...
                    },
                    {
                        ...
                        object: [
                            ["starch mix", "similar (total similar)", 3],
                            ["heated milk", "similar (total similar)", 2],
                        ],
                        ...
                        state_of_main_object:
                            " A pan is on the stove containing thickened milk soup, achieved by adding and cooking a mixture of water, starch, and salt in heated milk.",
                    },
                ],
                relation: [
                    [1.0, 0.7, 0.3, 0.2],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        object: [
                            ["bucket of olives", "similar shape", 1],
                            ["press machine", "new"],
                        ],
                    ...
                    },
                    {
                        step: "Extracting Oil",
                        object: [
                            ["press machine with crushed olives", "similar shape", 2],
                            ["oil collector", "new"],
                        ],
            ...
            },
            {
                ...
                steps: [
                    ...
                    },
                    {
                        step: "Clean Violets",
                        object: [
                            ["violets", "similar(total similar)", 1],
                            ["water", "new"],
                            ["sink", "new"],
                        ],
                    ...
                    },
                    {
                        step: "Steep Violets",
                        object: [
                            ["violets", "similar(shape similar)", 2],
                            ["hot water", "new"],
                            ["teapot", "new"],
                        ],
                    ...
                    },
                    {
                        step: "Strain and Serve",
                        object: [
                            ["teapot", "similar(texture similar)", 3],
                            ["teacup", "new"],
                            ["strainer", "new"],
                        ],
...
const accumulated_length = {
    gpt_0: 0,
    gpt_1: raw_data.gpt_0.goals.length,
    gpt_2: raw_data.gpt_0.goals.length + raw_data.gpt_1.goals.length,
    gpt_3: raw_data.gpt_0.goals.length + raw_data.gpt_1.goals.length + raw_data.gpt_2.goals.length,
    gpt_4: raw_data.gpt_0.goals.length + raw_data.gpt_1.goals.length + raw_data.gpt_2.goals.length + raw_data.gpt_3.goals.length,
};
...
const baseline_names = [
    ["independent", "kv"],
    ["act", "act_act"],
    ["kv", "kv_mask", "state_act"],
];

let selected_sample = [0, 0, 0, 0];
...
load_select_options(samples3, 3);
    ...
    if (index === selected_sample[section_id]) {
        ...
        for (let i = 0; i < 4; i++) {
            ...
            if (section_id === 0 || section_id === 1) {
                let image_path = `./images2/section${section_id}/${samples[index].subdir}/${samples[index].index}/${
                    baseline_names[section_id][selected_baseline[section_id]]
                }/${i}.jpg`;
            ...
            if (section_id === 3) {
                image_path = `./images2/section0/${samples[index].subdir}/${samples[index].index}/kv_weight_mask/${i}.jpg`;
                document.getElementById(`sect-${section_id}-sample-our-${i}`).src = image_path;
                baseline_subdir = accumulated_length[samples[index].subdir] + samples[index].index;
                gii_path = `./images2/gii/${baseline_subdir}/${i}.png`;
                document.getElementById(`sect-${section_id}-sample-gii-${i}`).src = gii_path;
                genhowto_state_path = `./images2/genhowto/${baseline_subdir}/state/${i}.png`;
                document.getElementById(`sect-${section_id}-sample-genhowto-state-${i}`).src = genhowto_state_path;
                genhowto_action_path = `./images2/genhowto/${baseline_subdir}/action/${i}.png`;
...
function select_sample3(select) {
    let index = parseInt(select.value.split("sample").slice(-1)[0]);
    selected_sample[3] = index;
    console.log(index, select.value);
    load_data(samples3, index, 3);
}
